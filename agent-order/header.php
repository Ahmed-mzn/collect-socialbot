					...
					<aside class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								<li data-intro='تعبئة إستمارة القوالب-1' class="slide">
									<a class="side-menu__item" href="#" onclick="getUrl()"><svg xmlns="http://www.w3.org/2000/svg"  class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg><span class="side-menu__label">الدخول إلى منصة المحادثات</span></a>
								</li>
                                
                                
                                <li class="side-item side-item-category">القوالب المدفوعة (ضاعف ارباحك)</li>
                                <li data-intro=' تعبئة إستمارة القوالب-3' class="slide">
                                <a class="side-menu__item" href="templates-3.php"><svg xmlns="http://www.w3.org/2000/svg"  class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M17.66,9.53l-7.07,7.07l-4.24-4.24l1.41-1.41l2.83,2.83l5.66-5.66L17.66,9.53z M4,12c0-2.33,1.02-4.42,2.62-5.88L9,8.5v-6H3 l2.2,2.2C3.24,6.52,2,9.11,2,12c0,5.19,3.95,9.45,9,9.95v-2.02C7.06,19.44,4,16.07,4,12z M22,12c0-5.19-3.95-9.45-9-9.95v2.02 c3.94,0.49,7,3.86,7,7.93c0,2.33-1.02,4.42-2.62,5.88L15,15.5v6h6l-2.2-2.2C20.76,17.48,22,14.89,22,12z"/></svg><span class="side-menu__label">تفعيل رسائل </span></a>
                                </li>


                                <li class="side-item side-item-category"> تقارير القوالب</li>
                                <li data-intro='تعبئة إستمارة القوالب-1' class="slide">
                                    <a class="side-menu__item" href="cart-reporte.php"><svg xmlns="http://www.w3.org/2000/svg"  class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M13,10h-2V8h2V10z M13,6h-2V1h2V6z M7,18c-1.1,0-1.99,0.9-1.99,2S5.9,22,7,22s2-0.9,2-2S8.1,18,7,18z M17,18 c-1.1,0-1.99,0.9-1.99,2s0.89,2,1.99,2s2-0.9,2-2S18.1,18,17,18z M8.1,13h7.45c0.75,0,1.41-0.41,1.75-1.03L21,4.96L19.25,4l-3.7,7 H8.53L4.27,2H1v2h2l3.6,7.59l-1.35,2.44C4.52,15.37,5.48,17,7,17h12v-2H7L8.1,13z"/></svg><span class="side-menu__label">تقارير السلات المتروكة</span></a>
                                </li>
